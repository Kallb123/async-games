...
| Base name | Outer Rim |
| --- | --- |
| **Wheat Field** | **Moisture Farm** |
| **Ranch** | **Grazer Pens** |
| **Bakery** | **Portion-Bread Stall** |
| **Cafe** | **Safehouse Cantina** |
| **Convenience Store** | **Outfitter's Post** |
| **Forest** | **Timber Camp** |
| **Stadium** | **Grav-Ball Arena** |
| **TV Station** | **Holovid Studio** |
| **Business Center** | **Claims Office** |
