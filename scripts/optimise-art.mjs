...
/** Every .png under public/art, at any depth. The untouched originals live
 *  outside it, under /art-masters, so there is nothing here to step around:
 *  this only ever walks art the app actually serves. */
