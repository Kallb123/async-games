...
A ready-to-use development environment for Async Games. It provisions Node 24
...
| Piece | Purpose |
|---|---|
| `Dockerfile` | Node 24 base image (`mcr.microsoft.com/devcontainers/javascript-node`) + `mongosh`; installs the app's dependencies (`npm ci`) at build time. |
