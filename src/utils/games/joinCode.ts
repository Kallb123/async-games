...
// Drawn from the CSPRNG (see random.ts): the code is the only thing standing
// between a stranger and a lobby, so it must not be guessable from codes the
// same server handed out earlier.
