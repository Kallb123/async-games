...
export const WHATS_NEW: WhatsNewGroup[] = [
    ...
    },
    {
        ...
        items: [
            {
                title: "Outbreak's result screen now charts the team's run",
                detail: "See how many cubes each player treated and how many times they travelled, turn by turn, on the result screen once the team cures — or loses to — the outbreak.",
                game: "outbreak",
            },
            {
