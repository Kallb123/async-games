...
export const WHATS_NEW: WhatsNewGroup[] = [
    ...
    },
    {
        ...
        items: [
            {
                title: "The Android back gesture no longer quits the app",
                detail: "Swiping back on the Android app used to close it outright, no matter where you were. It now takes you back a screen at a time, and only exits once you're already home.",
            },
            {
