...
import { usePushEvents } from "@/utils/hooks/usePushEvents";

// A game lands in the finished list when it ends (`GameOver`).
const COMPLETED_GAME_EVENTS = ['GameOver'] as const;
