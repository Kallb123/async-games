 ...
 * doesn't jump: the same `.ag-desk` shell and its two columns, so a wide window
 * lays this out exactly where the real screen will be, the same `AppRail` (with
 * no games to switch between yet), the "your move" hero and a turn card, then
